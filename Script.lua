...
-- Versão Avançada Otimizada: Sistema de Key, Viagem Linear (Velocidade 100), Auto Farm Morte (5 Studs acima da Cabeça), Fruit Dropdown Teleport & ESP Sync, Magnet Real Fisico
...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {"publicado123"} -- Nova senha definida aqui
   }
})
...
-- [[ ABA 1: AUTOMAÇÃO DE FARM (NPC MAGNET FÍSICO REAL) ]]
              ...
              while Flags.BringMobs do
                  ...
                  pcall(function()
                      ...
                      if character and character:FindFirstChild("HumanoidRootPart") then
                          ...
                          for _, npc in pairs(enemiesFolder:GetChildren()) do
                              if not Flags.BringMobs then break end
                              ...
                              if root and humanoid and humanoid.Health > 0 and not IsBoss(npc) then
                                  ...
                                  root.Position = myRoot.Position + (myRoot.CFrame.LookVector * 4)
                              end
                          end
                      end
                  end)
...
Rayfield:Notify({
   ...
   Content = "Sistema carregado. Insira a nova chave para começar.",
   Duration = 5,
   Image = 4483362458,
})
